...
Note that for now, we are ignoring the variables _'sex'_ and _'time_of_day'_ since we are focusing on how weather conditions affect the way people dress. These variables (along with _'temperature_celsius'_) will be used in the future when we want a more detailed analysis to account for chance variation.
